...
sed -i 's/192.168.1.1/192.168.88.2/g' package/base-files/files/bin/config_generate #修改默认ip
...
sed -i 's/OpenWrt/U3865U/g' package/base-files/files/bin/config_generate #修改主机名
sed -i '5a\zj "Compiler author"' feeds/luci/modules/luci-base/po/zh-cn/base.po #添加汉化
sed -i '6a\zj "编译作者"' feeds/luci/modules/luci-base/po/zh-cn/base.po #添加汉化
...
sed -i '8a\zj "Firmware Update"' feeds/luci/modules/luci-base/po/zh-cn/base.po #添加汉化
sed -i '9a\zj "固件更新"' feeds/luci/modules/luci-base/po/zh-cn/base.po #添加汉化
